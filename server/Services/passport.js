...
passportModule.initializePassport = function (app) {
  ...
  var loginStrategy = require(__base + 'Services/loginStrategy')(LocalStrategy,User);
  var registerStrategy = require(__base + 'Services/registerStrategy')(LocalStrategy,User);
